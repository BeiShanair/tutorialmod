...
public class ModConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> LEUCANTHEMUM_PALUDOSUM = register("leucanthemum_paludosum",
            Feature.FLOWER.withConfiguration(
                    (new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(ModBlocks.LEUCANTHEMUM_PALUDOSUM.get().getDefaultState()),
