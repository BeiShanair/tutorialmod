package com.besson.tutorialmod.world.structure;

import com.besson.tutorialmod.TutorialMod;
import com.besson.tutorialmod.world.structure.structures.HouseStructure;
...
public class ModStructures {
    public static final DeferredRegister<Structure<?>> STRUCTURE = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, TutorialMod.MOD_ID);
